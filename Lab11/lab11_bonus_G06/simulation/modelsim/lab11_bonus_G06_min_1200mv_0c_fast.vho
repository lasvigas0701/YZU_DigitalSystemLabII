...
-- Equation(s):
-- \LessThan2~2_combout\ = (((!pwm_count(5)) # (!pwm_count(8))) # (!pwm_count(6))) # (!pwm_count(7))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!clk_count(11) & (!clk_count(10) & (clk_count(9) & !clk_count(8))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (!clk_count(26) & (!clk_count(27) & (!clk_count(24) & !clk_count(25))))
...
-- Equation(s):
-- \rising~3_combout\ = (\rising~0_combout\ & (\rising~2_combout\ & \rising~1_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \rising~0_combout\,
	datac => \rising~2_combout\,
	datad => \rising~1_combout\,
...
-- Equation(s):
-- \clk_count~4_combout\ = (\Add0~32_combout\ & !\Equal0~9_combout\)
...
-- Equation(s):
-- \clk_count~6_combout\ = (\Add0~36_combout\ & !\Equal0~9_combout\)
...
-- Equation(s):
-- \duty[5]~23_combout\ = (\rising~q\ & ((duty(5) & (\duty[4]~22\ & VCC)) # (!duty(5) & (!\duty[4]~22\)))) # (!\rising~q\ & ((duty(5) & (!\duty[4]~22\)) # (!duty(5) & ((\duty[4]~22\) # (GND)))))
-- \duty[5]~24\ = CARRY((\rising~q\ & (!duty(5) & !\duty[4]~22\)) # (!\rising~q\ & ((!\duty[4]~22\) # (!duty(5)))))
...
-- Equation(s):
-- \duty[6]~25_combout\ = ((\rising~q\ $ (duty(6) $ (!\duty[5]~24\)))) # (GND)
-- \duty[6]~26\ = CARRY((\rising~q\ & ((duty(6)) # (!\duty[5]~24\))) # (!\rising~q\ & (duty(6) & !\duty[5]~24\)))
...
-- Equation(s):
-- \duty[8]~29_combout\ = ((\rising~q\ $ (duty(8) $ (!\duty[7]~28\)))) # (GND)
-- \duty[8]~30\ = CARRY((\rising~q\ & ((duty(8)) # (!\duty[7]~28\))) # (!\rising~q\ & (duty(8) & !\duty[7]~28\)))
...
-- Equation(s):
-- \rising~2_combout\ = (!duty(9) & (!duty(7) & (!duty(6) & !duty(8))))
...
-- Equation(s):
-- \rising~0_combout\ = (!duty(3) & (!duty(4) & (!duty(10) & \rising~q\)))
...
-- Equation(s):
-- \rising~1_combout\ = (!duty(5) & (!duty(1) & (!duty(2) & !duty(0))))
...
-- Equation(s):
-- \duty[10]~35_combout\ = (\Equal0~9_combout\ & (((!\rising~1_combout\) # (!\rising~0_combout\)) # (!\rising~2_combout\)))
...
-- Equation(s):
-- \duty[3]~19_combout\ = (\rising~q\ & ((duty(3) & (\duty[2]~18\ & VCC)) # (!duty(3) & (!\duty[2]~18\)))) # (!\rising~q\ & ((duty(3) & (!\duty[2]~18\)) # (!duty(3) & ((\duty[2]~18\) # (GND)))))
-- \duty[3]~20\ = CARRY((\rising~q\ & (!duty(3) & !\duty[2]~18\)) # (!\rising~q\ & ((!\duty[2]~18\) # (!duty(3)))))
...
-- Equation(s):
-- \LessThan0~2_combout\ = (((!duty(8)) # (!duty(7))) # (!duty(5))) # (!duty(6))
...
-- Equation(s):
-- \LessThan0~1_combout\ = (\LessThan0~0_combout\ & (((!duty(2)) # (!duty(0))) # (!duty(1))))
...
-- Equation(s):
-- \clk_count~2_combout\ = (!\Equal0~9_combout\ & \Add0~18_combout\)
...
-- Equation(s):
-- \clk_count~3_combout\ = (!\Equal0~9_combout\ & \Add0~28_combout\)
...
-- Equation(s):
-- \clk_count~5_combout\ = (\Add0~34_combout\ & !\Equal0~9_combout\)
...
-- Equation(s):
-- \Equal0~6_combout\ = (!clk_count(22) & (!clk_count(20) & (!clk_count(23) & !clk_count(21))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!clk_count(3) & (!clk_count(2) & (!clk_count(1) & !clk_count(0))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (clk_count(14) & (!clk_count(13) & (!clk_count(12) & !clk_count(15))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (clk_count(6) & (!clk_count(4) & (!clk_count(7) & !clk_count(5))))
...
-- Equation(s):
-- \Equal0~8_combout\ = (\Equal0~7_combout\ & (!clk_count(28) & (!clk_count(29) & !clk_count(30))))
...
-- Equation(s):
-- \LessThan2~0_combout\ = ((!pwm_count(2)) # (!pwm_count(1))) # (!pwm_count(0))
...
-- Equation(s):
-- \LessThan2~1_combout\ = (!pwm_count(4) & (!pwm_count(3) & \LessThan2~0_combout\))
...
-- Equation(s):
-- \LessThan2~3_combout\ = (pwm_count(10)) # ((!\LessThan2~2_combout\ & (pwm_count(9) & !\LessThan2~1_combout\)))
...
-- Equation(s):
-- \LessThan3~13_cout\ = CARRY((duty(6) & ((!\LessThan3~11_cout\) # (!pwm_count(6)))) # (!duty(6) & (!pwm_count(6) & !\LessThan3~11_cout\)))
...
-- Equation(s):
-- \LessThan3~19_cout\ = CARRY((duty(9) & (pwm_count(9) & !\LessThan3~17_cout\)) # (!duty(9) & ((pwm_count(9)) # (!\LessThan3~17_cout\))))
