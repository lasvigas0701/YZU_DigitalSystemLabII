...
ARCHITECTURE structure OF s1113341_lab06 IS
...
-- Equation(s):
-- \next_state.S1~0_combout\ = (\Din~input_o\ & \current_state.S3~q\)
...
-- Equation(s):
-- \next_state~4_combout\ = (\current_state.S1~q\) # (!\current_state.S0~q\)
...
-- Equation(s):
-- \Selector0~0_combout\ = (\Din~input_o\) # ((\current_state.S2~q\) # (\current_state.S3~q\))
...
-- Equation(s):
-- \Qout~0_combout\ = (\current_state.S3~q\) # (!\current_state.S0~q\)
